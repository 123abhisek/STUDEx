...
const Home = () => {
  ...
  const testimonials = [
    { id: 1, quote: 'STUDEx helped me realize I wasn\'t alone in my struggles', author: 'Alex, Sophomore' },
    { id: 2, quote: 'The toolkit gave me practical steps to overcome procrastination', author: 'Jamie, Senior' },
    { id: 3, quote: 'Sharing my story was therapeutic and helped others too', author: 'Taylor, Alumni' },
  ];
      ...
      <Box sx={{ 
        ...
        <Container maxWidth="md">
          ...
          <Typography variant="h6" sx={{ mb: 4 }}>
            Your story could be the light that guides someone else out of darkness.
          </Typography>
          <Button 
            variant="contained" 
            color="primary" 
